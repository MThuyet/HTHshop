...
@section('content')
    <div class="responsive flex justify-between gap-4 md:flex-row flex-col">
        ...
        {{-- Filter Modal --}}
        <div id="filterModal" class="fixed inset-0 bg-black bg-opacity-50 hidden flex justify-center items-center z-50">
                ...
                <fieldset class="mb-5">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center justify-between cursor-pointer">
                            <span>Áo thun</span>
                            <input type="checkbox" id="aoThunModal" class="w-5 h-5 accent-orange-500">
                        </label>
                        <label class="flex items-center justify-between cursor-pointer">
                            <span>Áo dài tay</span>
                            <input type="checkbox" id="aoDaiTayModal" class="w-5 h-5 accent-orange-500">
                        </label>
                    </div>
                </fieldset>
        ...
        <div class="shadow p-3 md:min-w-[200px] bg-gray rounded-lg h-fit md:block hidden">
            ...
            {{-- Thể loại --}}
            <fieldset class="mb-5 w-[80%]">
                <legend class="uppercase text-orangeColor text-[18px] tracking-widest mb-2 font-medium">Thể loại</legend>
                <div class="ml-4 space-y-3">
                    <div class="flex items-center justify-between">
                        <label class="cursor-pointer" for="aoThun">Áo thun</label>
                        <input type="checkbox" name="aoThun" id="aoThun"
                            class="w-5 h-5 cursor-pointer accent-orangeColor">
                    </div>
                    <div class="flex items-center justify-between">
                        <label class="cursor-pointer" for="aoDaiTay">Áo dài tay</label>
                        <input type="checkbox" name="aoDaiTay" id="aoDaiTay"
                            class="w-5 h-5 cursor-pointer accent-orangeColor">
                    </div>
                </div>
            </fieldset>
            ...
            <div class=" grid md:grid-rows-1 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-3 grid-cols-2 lg:gap-2 gap-4">
                ...
                <div
                    ...
                    <div class="md:px-4 md:py-2 p-2">
                        ...
                        <div class="flex items-center justify-between">
                            <div class="flex items-center gap-2">
                                <p class="text-orangeColor md:text-md sm:text-sm text-[14px] font-[550]">
                                    149.000đ</p>
                                <p class="text-[#888888] line-through text-[10px] sm:text-[12px]">220.000đ</p>
                            </div>
                        </div>
