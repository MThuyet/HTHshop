                        ...
                        <div class="flex-1 flex flex-col justify-between">
                            <div>
                                ...
                                <a href="{{ route('news.detail', $news->slug) }}" class="block group">
                                    <h3 class="text-lg font-bold mb-3 group-hover:text-[var(--orange-color)] transition-colors duration-300">
                                        {!! Str::limit($news->title, 70) !!}
                                    </h3>
                                </a>
                                <p class="text-sm text-gray-600 leading-relaxed mb-4">
                                    {!! Str::limit($news->excerpt, 120, '...') !!}
                                    <a href="{{ route('news.detail', $news->slug) }}" class="block text-[var(--orange-color)] font-medium">
