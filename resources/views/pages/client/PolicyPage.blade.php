        ...
        <div class="policy">
            ...
            <div class="policy__section">
              <p class="policy__text">
                Website <strong>HTHshop</strong> cam kết bảo mật thông tin cá nhân của khách hàng khi mua sắm các sản phẩm thời trang, bao gồm quần áo, phụ kiện và các mẫu logo thiết kế.
              </p>
            </div>
            ...
            <div class="policy__section">
              ...
              <ul class="policy__list">
                ...
                <li class="policy__list-item">Thông tin đăng nhập và cookie</li>
            ...
            <div class="policy__section">
              ...
              <p class="policy__text">Logo hoặc thiết kế do bạn gửi sẽ chỉ được sử dụng cho mục đích in lên sản phẩm của bạn. Chúng tôi cam kết không sử dụng hoặc chia sẻ thiết kế đó cho mục đích khác nếu không có sự đồng ý rõ ràng từ bạn.</p>
            </div>

            <div class="policy__section">
              <h2 class="policy__section-title">4. Chia sẻ với bên thứ ba</h2>
              <p class="policy__text">Thông tin chỉ được chia sẻ với đơn vị vận chuyển và thanh toán để phục vụ đơn hàng. Không chia sẻ cho bên thứ ba vì mục đích thương mại khác.</p>
            </div>

            <div class="policy__section">
              <h2 class="policy__section-title">5. Quyền của khách hàng</h2>
              <p class="policy__text">Bạn có quyền yêu cầu chỉnh sửa, truy cập hoặc xóa dữ liệu cá nhân bất kỳ lúc nào bằng cách liên hệ với chúng tôi.</p>
            </div>
            ...
            <div class="policy__section">
              ...
              <ul class="policy__contact-list">
                <li class="policy__contact-item">Email: support@tenwebcuaban.com</li>
                <li class="policy__contact-item">Hotline: 0909 123 456</li>
              </ul>
            </div>

            <div class="policy__section">
                <h2 class="policy__section-title">7. Chính sách đổi trả</h2>
                <p class="policy__text">Chúng tôi hỗ trợ đổi trả sản phẩm trong vòng <strong>7 ngày</strong> kể từ ngày nhận hàng, áp dụng với các trường hợp sau:</p>
                <ul class="policy__list">
                ...
                <p class="policy__text">Chúng tôi không áp dụng đổi trả với sản phẩm thiết kế theo yêu cầu (in logo riêng).</p>
            </div>
            ...
            <div class="policy__section">
                ...
                <ul class="policy__list">
                <li class="policy__list-item">Không sao chép, tái sử dụng nội dung, hình ảnh, logo trên website mà không có sự cho phép</li>
                <li class="policy__list-item">Không sử dụng website để thực hiện các hành vi gian lận, lừa đảo hoặc vi phạm pháp luật</li>
                <li class="policy__list-item">Không tải lên nội dung, hình ảnh phản cảm, vi phạm bản quyền khi sử dụng tính năng thiết kế áo/logo</li>
                </ul>
                <p class="policy__text">Chúng tôi có quyền chỉnh sửa các điều khoản mà không cần thông báo trước. Người dùng nên kiểm tra định kỳ để cập nhật thông tin.</p>
            </div>
