...
<div class="bg-white p-2 border border-1 rounded-md">
    ...
    <form method="GET" action="{{ route('dashboard.news-categories') }}" class="flex flex-col md:flex-row items-center justify-between mb-4 gap-3">
        ...
        <div class="flex gap-4">
            ...
            <a href="{{ route('dashboard.news-categories.create') }}"
            ...
            <tbody>
                ...
                <tr class="bg-white border-b hover:bg-gray-50 md:table-row py-2 md:py-0">
                    <td class="px-2 md:px-6 py-1 md:py-2 font-medium text-gray-900">
                        <a href="{{ route('dashboard.news-categories.show', $category->id) }}" class="material-symbols-rounded inline-flex rounded-md font-medium text-blue-500 border p-1 hover:underline">
                            info
                        </a>
                    </td>
                    ...
                    <!-- Trạng thái: toggle -->
                    <td class="px-6 py-2">
                        <form action="{{ route('dashboard.news-categories.toggle', $category->id) }}" method="POST" class="mb-0">
                            @csrf
                            @method('PUT')
                            <button type="submit">
                    ...
                    <td class="px-6 py-2">
                        <div class="flex justify-start">
                            <a href="{{ route('dashboard.news-categories.edit', $category->id) }}" class="inline-flex rounded-md font-medium text-yellow-500 border p-1 hover:underline mr-2">
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const openModal = (e) => {
            ...
            // Set form action
            form.action = `/dashboard/news-categories/${newsCategoryId}`;
