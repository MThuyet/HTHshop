...
<div class="bg-white p-2 border border-1 rounded-md">
    <form method="GET" action="{{ route('admin.product-category') }}" class="flex flex-col md:flex-row items-center justify-between mb-4 gap-3">
        ...
        <div class="flex flex-wrap justify-center gap-5 items-center mt-3 px-2">
            ...
            <div class="flex items-center gap-1">
                @if ($productCategory->lastPage() > 1)
                    {{ 
                        $productCategory->appends(['limit-row-length' => $perPage, 'search' => request('search')])
...
<script>
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const openModal = (e) => {
            ...
            form.action = `/admin/product-category/${productCategoryId}`;
