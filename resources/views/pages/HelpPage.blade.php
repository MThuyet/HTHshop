                ...
                <div class="faq__list">
                    ...
                    <div class="faq__item">
                        ...
                        <div
                            ...
                            1. Sản phẩm có giống với màu và hình ảnh thực tế sản phẩm không?
                        </div>

                        <div class="faq__answer p-3 text-textColor">
                            Chào bạn, sản phẩm như hình bạn nhé. Màu sắc qua ảnh chụp sẽ có thể có chút chênh lệch không
                            đáng kể so với thực tế ạ.</div>
                    </div>
                    ...
                    <div class="faq__item">
                        ...
                        <div
                            class="faq__question cursor-pointer py-3 px-2 font-semibold shadow-sm rounded hover:text-orangeColor transition-all">
                            2. Sản phẩm báo hết hàng khi nào sẽ về lại hàng?
                        </div>
                    ...
                    <div class="faq__item">
                        ...
                        <div
                            class="faq__question cursor-pointer py-3 px-2 font-semibold shadow-sm rounded hover:text-orangeColor transition-all">
                            3. Làm sao để tôi có thể mua hàng?
                        </div>
                    ...
                    <div class="faq__item">
                        ...
                        <div
                            class="faq__question cursor-pointer py-3 px-2 font-semibold shadow-sm rounded hover:text-orangeColor transition-all">
                            4. Tôi có thể tùy chỉnh hình ảnh tôi muốn để in trên áo không?
                        </div>
