...
@section('content')
    <div class="lg:w-10/12 md:w-11/12 mx-auto py-5 px-4">
            ...
            <form action="" method="POST" class="xl:col-span-1">
                <div class="grid lg:grid-cols-2 md:grid-cols-1 gap-5">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <textarea id="message" name="message" cols="30" rows="8" placeholder="Tin nhắn" minlength="1" maxlength="500" required
                    ...
                    <button class="bg-[var(--red-color)] text-white rounded-md px-[20px] h-[40px] leading-[40px] mt-[20px] hover:bg-[var(--orange-color)]">
                        <b>Gửi liên hệ</b>
                    </button>
                </div>
                @csrf
            </form>
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d293.957653563369!2d106.86132012160087!3d10.95471234698858!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3174dc2a78299a93%3A0x3797df49a37b9efc!2zMzggxJAuIMSQ4bq3bmcgxJDhu6ljIFRodeG6rXQsIFRhbSBIb8OgLCBCacOqbiBIw7JhLCDEkOG7k25nIE5haQ!5e0!3m2!1svi!2s!4v1743244171854!5m2!1svi!2s" style="border:0;" width="100%" height="100%" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="min-h-[400px]"></iframe>
        </div>

        <div class="overflow-hidden">
            <h2 class="text-3xl font-bold my-8 text-center">Cơ Sở Chính</h2>
            ...
            <div class="grid grid-cols-1 xl:grid-cols-4 gap-6 mb-8">
                <div class="xl:col-span-2 flex items-start gap-4 p-4 rounded-lg bg-[#f9f9f9] shadow-md">
                    <div class="flex-shrink-0">
                        <div class="bg-red-600 rounded-full h-[40px] leading-[40px] w-[40px] flex items-center justify-center">
        ...
        <h2 class="text-2xl font-bold my-5">Chi nhánh</h2>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2 md:col-span-1 space-y-4">
                <div class="flex items-start gap-4 bg-gray-50 rounded-lg p-4 bg-[#f9f9f9] shadow-md">
                    <div class="flex-shrink-0">
    ...
    <div id="imageLightbox" class="fixed inset-0 bg-black bg-opacity-80 z-50 hidden flex items-center justify-center p-4">
