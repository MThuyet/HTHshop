...
@section('content')
    <div class="register__container mt-6">
        <div class="register__wrapper-left">
            <form action="" method="POST">
                <h2>Đăng ký tài khoản</h2>
                <div class="mb-3">
                    <label for="username">Tên tài khoản <span style="color: var(--red-color)">*</span></label>
                    <input id="username" placeholder="Tên tài khoản" type="text" name="username" pattern="[A-Za-zÀ-ỹ ]+$"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <input id="phone-number" placeholder="Số điện thoại" type="tel" name="phoneNumber"
                ...
                <div class="mb-3">
                    ...
                    <input id="password" type="password" placeholder="Mật khẩu" name="password" minlength="5"
