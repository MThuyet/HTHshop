...
const inputs = {
    lastName: registerForm.querySelector('input[name="lastName"]'),
    firstName: registerForm.querySelector('input[name="firstName"]'),
...
const validationRules = {
    lastName: [
        ...
        {
            test: value => value.length >= 2 && value.length <= 25,
            message: "Họ phải dài từ 2 đến 25 kí tự"
        }
    ],
    firstName: [
        {
        ...
        {
            test: value => value.length >= 2 && value.length <= 25,
            message: "Tên phải dài từ 2 đến 25 kí tự"
        }
    ],
    phoneNumber: [
        {
